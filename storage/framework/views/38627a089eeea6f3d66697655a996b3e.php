...
<?php endif; ?>
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-between mb-3 items-start">
        <!--[if BLOCK]><![endif]--><?php if(checkPermission('tenant.ai_prompt.create')): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-791966997-0', $__slots ?? [], get_defined_vars());
...
<?php $component->withAttributes(['id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('ai_prompt-modal'),'maxWidth' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('2xl'),'wire:model' => 'showAiPromptModal']); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if(!$prompt && isset($this->hasReachedLimit) && $this->hasReachedLimit): ?>
        <div class="px-6 pt-4">
...
<?php endif; ?>
</div><?php /**PATH /home/adphwiudpl/mark.chatvoo.com/resources/views/livewire/tenant/chat/manage-ai-prompt.blade.php ENDPATH**/ ?>