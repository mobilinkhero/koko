                ...
                <div class="flex animate-scroll-logos">
                    ...
                    if (count($logos) < $minLogosNeeded) { // Repeat the logos array until we have enough
                        ...
                        <div class="flex items-center space-x-12 lg:space-x-16 px-8 animate-scroll">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $duplicatedLogos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $logo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex-shrink-0 logo-container group">
                                <!--[if BLOCK]><![endif]--><?php if(isset($logo['url']) && !empty($logo['url'])): ?>
                                <a href="<?php echo e($logo['url']); ?>" target="_blank" rel="noopener" class="block">
                                    <img src="<?php echo e(isset($logo['path']) ? asset('storage/' . $logo['path']) : asset('img/dummy-image/dummy_192x48.png')); ?>"
...
</div><?php /**PATH /home/adphwiudpl/mark.chatvoo.com/resources/views/livewire/frontend/partner-logos.blade.php ENDPATH**/ ?>