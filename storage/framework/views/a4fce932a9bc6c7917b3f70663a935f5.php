...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['expanded' => false]));
...
foreach (array_filter((['expanded' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div x-data="{ expanded: <?php echo json_encode($expanded, 15, 512) ?> }">
...
<?php endif; ?>
<?php $component->withAttributes(['x-cloak' => true,'x-show' => 'expanded','class' => 'h-5 w-5']); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-show' => '!expanded','class' => 'h-5 w-5']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php /**PATH /home/adphwiudpl/mark.chatvoo.com/resources/views/components/accordion.blade.php ENDPATH**/ ?>