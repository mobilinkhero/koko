...
<div>
    <footer
        style="background-image: url('<?php echo e(asset('img/landingpage-image/testimonial-section/testimonial-grid.png')); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;"
        ...
        <div class="relative max-w-screen-xl px-4 py-12 mx-auto lg:py-16 lg:px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div class="lg:col-span-2">
                    <a href="<?php echo e(env('APP_URL')); ?>" class="flex items-center mb-6">
                        <img src="<?php echo e($siteLogo); ?>" alt="Application Logo" class="h-12" />
                    </a>
            ...
            <div class="pt-8 border-t border-white">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <div class="mb-4 md:mb-0">
                        <span x-data="{ year: '' }" x-init="const timezone = '<?php echo e(get_setting('system.timezone')); ?>';
                        const now = new Date().toLocaleString('en-US', { timeZone: timezone });
                        year = new Date(now).getFullYear();" class="text-sm text-white">
                            © <span x-text="year"></span>-<span x-text="year + 1"></span>
                            <?php echo e(get_setting('system.company_name')); ?>. All Rights Reserved.
                        </span>
                    </div>
        ...
        <?php if(!empty($footerJs)): ?>
            <?php echo $footerJs; ?>

        <?php endif; ?>
    </footer>
</div>
<?php /**PATH /home/adphwiudpl/mark.chatvoo.com/resources/views/themes/thecore/components/elements/footer.blade.php ENDPATH**/ ?>