...
<?php endif; ?>
    ...
    <div class="flex justify-start mb-3 lg:px-0 items-center gap-2">
        <!--[if BLOCK]><![endif]--><?php if(checkPermission('admin.tenants.create')): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3377485923-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /home/adphwiudpl/mark.chatvoo.com/resources/views/livewire/admin/tenant/tenant-list.blade.php ENDPATH**/ ?>