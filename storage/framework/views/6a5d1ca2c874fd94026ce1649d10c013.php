...
<div>
    ...
    <div>
        <!--[if BLOCK]><![endif]--><?php if(!empty($testimonials) && count($testimonials) > 0): ?>
        <section x-data="{
                currentIndex: 0,
                testimonials: <?php echo e(Js::from($testimonials)); ?>,
                interval: null,
                get totalPairs() {
                                                ...
                                                <div class="flex items-center space-x-3 mt-auto pt-2">
                                                    <div class="relative flex-shrink-0">
                                                        <img :src="testimonials[pairIndex * 2].profile_image ?
                                                                '<?php echo e(asset('storage')); ?>/' + testimonials[pairIndex * 2]
                                                                .profile_image :
                                                                '<?php echo e(asset('img/user-placeholder.jpg')); ?>'"
...
</div><?php /**PATH /home/adphwiudpl/mark.chatvoo.com/resources/views/livewire/frontend/testimonials.blade.php ENDPATH**/ ?>