    ...
    <div class="items-center  gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
        <div class="text-gray-500 lg:p-1 p-4 sm:text-lg dark:text-gray-400">
            <h2 id="uniqueFeatureText"
                ...
                <?php echo e($uniqueSettings['theme.uni_feature_title'] ?: 'Default Title'); ?>

            </h2>
            <p class="mb-8 lg:text-lg">
                <?php echo e($uniqueSettings['theme.uni_feature_sub_title'] ?: 'Default Subtitle'); ?>
            ...
            <p class="mb-8 lg:text-lg"><?php echo e($uniqueSettings['theme.uni_feature_description']); ?></p>
        </div>
        <div style="background-image: url('<?php echo e(asset('img/landingpage-image/feature-1/featuresec-bg.png')); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;"
            ...
            <!--[if BLOCK]><![endif]--><?php if($uniqueSettings['theme.uni_feature_image']): ?>
            <?php
            ...
            <div class="w-lg h-[300px] ">
                <img data-aos="fade-right" data-aos-once="true" data-aos-duration="1000"
                    src="<?php echo e(asset('img/dummy-image/dummy_400x300.png')); ?>" class="w-full animate-bounce-slow-subtle"
                    alt="">
            </div>
...
</div><?php /**PATH /home/adphwiudpl/mark.chatvoo.com/resources/views/livewire/frontend/unique-feature.blade.php ENDPATH**/ ?>