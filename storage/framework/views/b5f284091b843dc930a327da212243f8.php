<div>
    <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
        ...
        <div style="background-image: url('<?php echo e(asset('img/landingpage-image/feature-1/featuresec-bg.png')); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;"
            ...
            <!--[if BLOCK]><![endif]--><?php if($featureSettings['theme.feature_image_three']): ?>
            <?php
        ...
        <div class="text-gray-500 lg:p-1 p-4  sm:text-lg dark:text-gray-400">
            <h2 id="featureSectionText"
                ...
                <?php echo e($featureSettings['theme.feature_title_three']); ?></h2>
            <p class="mb-8 f lg:text-lg"><?php echo e($featureSettings['theme.feature_subtitle_three']); ?></p>
            <!-- List -->
            ...
            <p class="lg:text-lg"><?php echo e($featureSettings['theme.feature_description_three']); ?></p>
        </div>

    </div>
</div><?php /**PATH /home/adphwiudpl/mark.chatvoo.com/resources/views/livewire/frontend/feature-three.blade.php ENDPATH**/ ?>